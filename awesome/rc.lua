...
local themes = {
    "blackburn",		-- 1 Nice border color and left bar icon
    "copland",      	-- 2 Nice sound controller
    "multicolor",	 	-- 3
    "powerarrow",		-- 4
    "powerarrow-blue",  -- 5
    "powerarrow-dark",  -- 6 Nice bar
}
...
local modkey       = "Mod4" -- Start
local altkey       = "Mod1"  --Alt
local modkey1      = "Control"  -- Control KeY
...
globalkeys = my_table.join(
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    --         end
    --     end,
    --     {description = "go back", group = "client"}), -- Ctrl + Tab -> go back
